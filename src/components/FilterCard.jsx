const FilterCard = ({ img, text }) => {
  return (
    <div className="group relative flex h-32 w-32 cursor-pointer flex-col gap-4 overflow-hidden rounded-lg border p-4 transition-all duration-300 md:h-40 md:w-40">
